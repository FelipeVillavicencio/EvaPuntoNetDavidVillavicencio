...
namespace EvaCursoPuntoNet.Controllers
{
    ...
    public class ProductCategoriesController : Controller
    {
        ...
        {
            var adventureWorksLt2019Context = _context.ProductCategories.Include(p => p.ParentProductCategory);
        ...
        {
            ViewData["ParentProductCategoryId"] = new SelectList(_context.ProductCategories, "ProductCategoryId", "ProductCategoryId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductCategoryId,ParentProductCategoryId,Name,Rowguid,ModifiedDate")] ProductCategory productCategory)
        {
            ...
            ViewData["ParentProductCategoryId"] = new SelectList(_context.ProductCategories, "ProductCategoryId", "ProductCategoryId", productCategory.ParentProductCategoryId);
            return View(productCategory);
        }
